<head>
    ...
    <!-- Fancy Box CSS -->
    <link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/jquery.fancybox.min.css">
    <!-- Owl Carousel CSS -->
    ...
    <!-- Learedu Stylesheet -->
    <link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/normalize.css">
    ...
    <!-- Learedu Color -->
    <link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color1.css">
    <!--<link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color2.css">-->
    <!--<link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color3.css">-->
    <!--<link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color4.css">-->
    <!--<link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color5.css">-->
    <!--<link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color6.css">-->
    <!--<link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color7.css">-->
    <!--<link rel="stylesheet"  href="<?php echo base_url("public/front/") ?>css/color/color8.css">-->
