        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class="bread-list">
                    ...
                    <li class="active"><a><?php echo $this->lang->line("muellimler") ?></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="member-detail">
                    ...
                    <div class="contact">
                        <ul class="social">
                            <li><a href="<?php echo $teacher['instagram'] ?>"><i class="fa fa-instagram"></i></a></li>
                            <li><a href="<?php echo $teacher['facebook'] ?>"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="<?php echo $teacher['twitter'] ?>" class="active"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="<?php echo $teacher['telegram'] ?>"><i class="fa fa-paper-plane"></i></a></li>
                            <li><a href="<?php echo $teacher['linkedln'] ?>"><i class="fa fa-linkedin"></i></a></li>
                        </ul>
                        <ul class="address">
